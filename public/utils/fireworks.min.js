(() => {
  ...
  // 保存动画引用
  window.fireworksAnimation = s;

  // 点击事件处理函数
  var clickHandler = (e) => {
    s.play(),
      (function (e) {
        (a = e.clientX || (e.touches && e.touches[0].clientX)),
          (t = e.clientY || (e.touches && e.touches[0].clientY));
      })(e),
      l(a, t);
  };

  // 保存事件处理函数引用
  window.fireworksClickHandler = clickHandler;
  window.fireworksResizeHandler = r;
